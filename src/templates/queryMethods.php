...
{
    return $this
        ->condition('first-one', '<?php $fullNameRefColumn1 ?> = ?', is_object($object1) ? $object1->getPrimaryKey() : $object1)
        ->condition('first-two', '<?php $fullNameRefColumn2 ?> = ?', is_object($object2) ? $object2->getPrimaryKey() : $object2)
        ->condition('second-one', '<?php $fullNameRefColumn2 ?> = ?', is_object($object1) ? $object1->getPrimaryKey() : $object1)
        ->condition('second-two', '<?php $fullNameRefColumn1 ?> = ?', is_object($object2) ? $object2->getPrimaryKey() : $object2)
